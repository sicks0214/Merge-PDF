...
export function ResultPage({ result, onReset }: ResultPageProps) {
  ...
  return (
    <div className="flex flex-col items-center max-w-md mx-auto">
      ...
      {/* Export As dropdown placeholder */}
      <button className="w-full mt-3 py-3 px-6 border border-gray-200 text-gray-600 font-medium rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center gap-2">
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
